...
export function ReceiptDetail() {
  ...
  // Decoding the path parameter, e.g. WH/IN/00001
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 max-w-3xl">
            <div className="flex items-center justify-between border-b border-borders/60 pb-1">
              <span className="text-text-secondary font-medium mr-4">Receive From</span>
              <span className="text-text-primary font-semibold text-sm">Vendor / Global Electronics Ltd</span>
            </div>
            <div className="flex items-center justify-between border-b border-borders/60 pb-1">
